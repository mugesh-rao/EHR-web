...
function Cards() {
  return (
    <>
      <section class="flex flex-col justify-center antialiased bg-red-200 text-gray-600 min-h-screen p-4 ">
        <div class="h-full">
          {/* <!-- Card --> */}
            ...
            <div class="bg-white shadow-lg rounded-lg mt-9">
              ...
              <div class="bg-gray-100 text-center px-5 py-6">
                <div class="text-sm mb-6">
                  <strong class="font-semibold">$2.700</strong> due Jan 27, 2022
                </div>
                <form class="space-y-3">
                  <div class="flex shadow-sm rounded">
                    <div class="flex-grow">
                      <input
                        name="card-nr"
                        class="text-sm text-gray-800 bg-white rounded-l leading-5 py-2 px-3 placeholder-gray-400 w-full border border-transparent focus:border-slate-300 focus:ring-0"
                        type="text"
                    ...
                    <div class="flex-none w-[4.8rem]">
                      <input
                        name="card-expiry"
                        class="text-sm text-gray-800 bg-white leading-5 py-2 px-3 placeholder-gray-400 w-full border border-transparent focus:border-slate-300 focus:ring-0"
                        type="text"
                        placeholder="MM/YY"
                    ...
                    <div class="flex-none w-[3.5rem]">
                      <input
                        name="card-cvc"
                        class="text-sm text-gray-800 bg-white rounded-r leading-5 py-2 px-3 placeholder-gray-400 w-full border border-transparent focus:border-slate-300 focus:ring-0"
                        type="text"
                        placeholder="CVC"
                        aria-label="CVC"
                      />
                  ...
                  <button
                    type="submit"
                    class="font-semibold text-sm inline-flex items-center justify-center px-3 py-2 border border-transparent rounded leading-5 shadow transition duration-150 ease-in-out w-full bg-slate-500 hover:bg-slate-600 text-white focus:outline-none focus-visible:ring-2"
                  >
                    Pay Now
                  </button>
                </form>
